...
Procure arquivos como `id_rsa.pub` ou `id_ed25519.pub`.
...
- Digite uma senha (opcional, mas recomendada).
...
2. Cole a chave e dê um nome (ex.: "PC do Trabalho").
...
Agora você pode usar SSH para clonar e enviar código:
